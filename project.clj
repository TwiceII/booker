(defproject booker "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "booker.core/on-figwheel-reload"}

                :compiler {:main booker.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/booker.js"
